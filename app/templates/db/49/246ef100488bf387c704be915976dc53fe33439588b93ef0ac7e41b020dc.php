...
\t";
            ...
            if ((!call_user_func_array($this->env->getTest('empty')->getCallable(), array((isset($context["next"]) ? $context["next"] : null))))) {
                // line 14
                echo "\t";
                $context["url"] = (("../" . call_user_func_array($this->env->getFunction('getSibling')->getCallable(), array(call_user_func_array($this->env->getFilter('removeExtension')->getCallable(), array((isset($context["next"]) ? $context["next"] : null)))))) . "/");
                // line 15
                echo "\t<a href='";
...
\t";
            ...
            if ((!call_user_func_array($this->env->getTest('empty')->getCallable(), array((isset($context["prev"]) ? $context["prev"] : null))))) {
                // line 19
                echo "\t";
                $context["url"] = (("../" . call_user_func_array($this->env->getFunction('getSibling')->getCallable(), array(call_user_func_array($this->env->getFilter('removeExtension')->getCallable(), array((isset($context["prev"]) ? $context["prev"] : null)))))) . "/");
                // line 20
                echo "\t<a href='";
                echo (isset($context["url"]) ? $context["url"] : null);
