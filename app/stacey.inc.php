...
Class Stacey {
  ...
  static $version = '3.23.0';
  static $version_date = 1497291878083;
  ...
  function create_page($file_path) {
    ...
    $template_name = is_file($file_path) ? 'file' : ($file_path !== './content/custom/404' && strpos($file_path, './content/custom') === 0 ? '404' : 'page');
